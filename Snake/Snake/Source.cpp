...
using namespace std;
bool gameOver,SpawnedBonus,SpawnedCoada,SpawnedSlow;
const int width=50;
const int height=20;
int x, y;
int x1, y1, fruitX, fruitY, score, bonusX,bonusY,coadaX,coadaY,slowX,slowY,SLOW;
...
if(x1==coadaX&&y1==coadaY)
{nTail1=nTail1-1;score++;coadaX=0;SpawnedCoada=false;}
...
void power_up_slow()
{
if(score%3==0&&score>1&&SpawnedSlow==false)
{slowX = 1+(rand() % (width-3));
...
if(x1==slowX&&y1==slowY)
{slowX=0;score++;SpawnedSlow=false;slowX=0;SLOW=10;}
